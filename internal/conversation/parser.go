...
// Parse takes a path to a JSON file containing a conversation,
// and loads the data into a Conversation struct. It returns
// a pointer to the Conversation struct.
